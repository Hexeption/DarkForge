 ...
 */
public class HuzuniExpandingButton extends ComponentRenderer {

    public HuzuniExpandingButton(Theme theme) {
    ...
    public void drawComponent(Component component, int mouseX, int mouseY) {
        ...
        if (button.isEnabled()) {
//            GuiUtils.drawBorderedRect(button.getX(), button.getY(), button.getX() + button.getDimension().width - 1, button.getY() + 18,2, Color.black.hashCode(), enable.hashCode());
        ...
        if (GLUtils.isHovered(button.getX(), button.getY(), button.getDimension().width, 18, mouseX, mouseY)) {
            ...
            renderToolTip(button, button.getMod().getDescription(), new Point(mouseX, mouseY));
        }
