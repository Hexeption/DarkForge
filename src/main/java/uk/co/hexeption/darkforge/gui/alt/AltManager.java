...
public class AltManager extends GuiScreen {
    ...
    public void initGui() {
        ...
        buttonList.clear();
        buttonList.add(new GuiButton(0, width / 2 - 111, height - 25, 46, 20, I18n.format("gui.done")));
        ...
        buttonList.add(new GuiButton(6, width / 2 + 65 + 100, height - 25, 46, 20, "Favorite"));
    }
...
//                mc.displayGuiScreen(new GuiProxy(this));
    ...
    public void updateScreen() {
        ...
        buttonList.get(3).enabled = !AltsSlot.alts.isEmpty() && altslot.getSelectedSlots() != -1;
        buttonList.get(4).enabled = !AltsSlot.alts.isEmpty() && altslot.getSelectedSlots() != -1;
        buttonList.get(6).enabled = !AltsSlot.alts.isEmpty() && altslot.getSelectedSlots() != -1;
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        DarkForge.INSTANCE.fontManager.hud.drawCenteredString("Account Manager", width / 2, 7, 16777215);
        DarkForge.INSTANCE.fontManager.hud.drawCenteredString(login + AltsSlot.login, width / 2, 15, 16777215);
        DarkForge.INSTANCE.fontManager.hud.drawCenteredString("§aCurrently signed in as " + this.mc.getSession().getUsername(), width / 2, height - 35, 16777215);
